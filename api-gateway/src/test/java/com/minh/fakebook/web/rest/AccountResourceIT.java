package com.minh.fakebook.web.rest;

import static com.minh.fakebook.test.util.OAuth2TestUtil.TEST_USER_LOGIN;
import static com.minh.fakebook.test.util.OAuth2TestUtil.authenticationToken;
import static com.minh.fakebook.test.util.OAuth2TestUtil.registerAuthenticationToken;
import static org.springframework.security.test.web.reactive.server.SecurityMockServerConfigurers.*;

import com.minh.fakebook.IntegrationTest;
import com.minh.fakebook.security.AuthoritiesConstants;
...
class AccountResourceIT {
    ...
    void testGetUnknownAccount() {
        webTestClient.get().uri("/api/account").accept(MediaType.APPLICATION_JSON).exchange().expectStatus().isUnauthorized();
    }
