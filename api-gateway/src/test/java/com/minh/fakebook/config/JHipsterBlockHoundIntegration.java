...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("com.minh.fakebook.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("com.minh.fakebook.security.DomainUserDetailsService", "createSpringSecurityUser");
