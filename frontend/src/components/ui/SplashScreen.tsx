interface SplashScreenProps {
  /** Optional accessible message for screen readers or aria-label */
  message?: string;
  className?: string;
}
...
export default function SplashScreen({
  ...
  return (
    <main
      ...
      aria-live="polite"
      aria-label={message}
      className={`fixed inset-0 z-50 flex items-center justify-center bg-white select-none ${className}`}
    >
      <span className="sr-only">{message}</span>

      {/* Center Facebook Logo */}
      <div className="flex items-center justify-center animate-fb-pulse">
        <svg
          viewBox="0 0 40 40"
          className="w-18 h-18 md:w-20 md:h-20 drop-shadow-sm"
          aria-hidden="true"
        >
      ...
      <div className="absolute bottom-8 left-0 right-0 flex flex-col items-center justify-center pointer-events-none">
        <span className="text-[11px] text-[#8a8d91] font-normal tracking-wide lowercase mb-1">
          from
        </span>
        <svg
          viewBox="0 0 948 191"
        ...
        >
          <defs>
            <linearGradient id="splash-meta-grad1" x1="61" y1="117" x2="259" y2="127" gradientUnits="userSpaceOnUse">
            ...
            <linearGradient id="splash-meta-grad2" x1="45" y1="139" x2="45" y2="66" gradientUnits="userSpaceOnUse">
