        ...
        {activeTab === "giới thiệu" && (
          <div className="bg-white rounded-xl border border-[#E4E6EB] p-4 sm:p-6 shadow-sm flex flex-col md:flex-row gap-6">
            ...
            <div className="w-full md:w-[240px] flex-shrink-0 border-b md:border-b-0 md:border-r border-[#E4E6EB] pr-0 md:pr-4 pb-4 md:pb-0 space-y-1">
              ...
              >
                <svg className="w-5 h-5 text-[#65676B]" fill="currentColor" viewBox="0 0 24 24"><path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 3c1.66 0 3 1.34 3 3s-1.34 3-3 3-3-1.34-3-3 1.34-3 3-3zm0 14.2c-2.5 0-4.71-1.28-6-3.22.03-1.99 4-3.08 6-3.08 1.99 0 5.97 1.09 6 3.08-1.29 1.94-3.5 3.22-6 3.22z"/></svg> Tổng quan
              </button>
              <button
              ...
              >
                <svg className="w-5 h-5 text-[#65676B]" fill="currentColor" viewBox="0 0 24 24"><path d="M20 6h-4V4c0-1.11-.89-2-2-2h-4c-1.11 0-2 .89-2 2v2H4c-1.11 0-1.99.89-1.99 2L2 19c0 1.11.89 2 2 2h16c1.11 0 2-.89 2-2V8c0-1.11-.89-2-2-2zm-6 0h-4V4h4v2z"/></svg> Công việc và học vấn
              </button>
              <button
              ...
              >
                <svg className="w-5 h-5 text-[#65676B]" fill="currentColor" viewBox="0 0 24 24"><path d="M12 3L2 12h3v8h6v-6h2v6h6v-8h3L12 3zm5 15h-2v-6H9v6H7v-7.81l5-4.5 5 4.5V18z"/></svg> Nơi từng sống
              </button>
              <button
