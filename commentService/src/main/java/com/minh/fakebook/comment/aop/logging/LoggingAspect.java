package com.minh.fakebook.comment.aop.logging;
...
public class LoggingAspect {
    ...
    @Pointcut(
        """
        within(com.minh.fakebook.comment.repository..*)
        || within(com.minh.fakebook.comment.service..*)
        || within(com.minh.fakebook.comment.web.rest..*)
        """
    )
