...
/**
 * Criteria class for the {@link com.minh.fakebook.comment.domain.CommentReaction} entity. This class is used
 * in {@link com.minh.fakebook.comment.web.rest.CommentReactionResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /comment-reactions?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class CommentReactionCriteria implements Serializable, Criteria {
    ...
    public CommentReactionCriteria() {}

    public CommentReactionCriteria(CommentReactionCriteria other) {
    ...
    @Override
    public CommentReactionCriteria copy() {
        return new CommentReactionCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final CommentReactionCriteria that = (CommentReactionCriteria) o;
        return (
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, userId, reactionType, createdAt, updatedAt, commentId, distinct);
    }

    // prettier-ignore
    @Override
    public String toString() {
        return "CommentReactionCriteria{" +
