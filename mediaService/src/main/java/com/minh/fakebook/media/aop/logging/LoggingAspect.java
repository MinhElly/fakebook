package com.minh.fakebook.media.aop.logging;
...
public class LoggingAspect {
    ...
    @Pointcut(
        """
        within(com.minh.fakebook.media.repository..*)
        || within(com.minh.fakebook.media.service..*)
        || within(com.minh.fakebook.media.web.rest..*)
        """
    )
