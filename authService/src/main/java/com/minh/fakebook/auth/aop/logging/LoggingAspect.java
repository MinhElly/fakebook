package com.minh.fakebook.auth.aop.logging;
...
public class LoggingAspect {
    ...
    @Pointcut(
        """
        within(com.minh.fakebook.auth.repository..*)
        || within(com.minh.fakebook.auth.service..*)
        || within(com.minh.fakebook.auth.web.rest..*)
        """
    )
