package com.minh.fakebook.gateway.web.filter;
...
class SpaWebFilterIT {
    ...
    @Test
    @WithAnonymousUser
    void staticAssetsArePubliclyAccessible() {
        webTestClient
            .get()
            ...
            .isOk()
            .expectBody(String.class)
            .value(body -> assertThat(body).isEqualToNormalizingNewlines("test resource\n"));
    }
