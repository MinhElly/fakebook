package com.minh.fakebook.post.aop.logging;
...
public class LoggingAspect {
    ...
    @Pointcut(
        """
        within(com.minh.fakebook.post.repository..*)
        || within(com.minh.fakebook.post.service..*)
        || within(com.minh.fakebook.post.web.rest..*)
        """
    )
