package com.minh.fakebook.feed.aop.logging;
...
public class LoggingAspect {
    ...
    @Pointcut(
        """
        within(com.minh.fakebook.feed.repository..*)
        || within(com.minh.fakebook.feed.service..*)
        || within(com.minh.fakebook.feed.web.rest..*)
        """
    )
